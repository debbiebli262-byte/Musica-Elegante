...
async function startServer() {
  ...
  // API to resolve website URL to a representative image URL
  app.get("/api/resolve-image", async (req, res) => {
    ...
    try {
      ...
      // Simple regex to find common image meta tags
      ...
      // If no meta tags, try to find the first large-ish image
